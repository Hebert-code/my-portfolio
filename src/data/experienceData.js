...
export const experiences = [
  ...
  {
    year: "Set 2025 - Atual",
    title: "Pesquisador de Iniciação Científica (IA Generativa)",
    company: "FAPESB",
    description:
  ...
  },
  {
    ...
    title: "Desenvolvedor – Projeto de Extensão (PIBITI)",
    company: "UNIVASF / CNPq",
    description:
      "Desenvolvimento de aplicação para correção automática de redações do ENEM com LLMs. Design no Figma e implementação com Django, HTML, CSS e Bootstrap. Integração com Deepseek, ChatGPT, Gemini e Maritaca.",
    image: logo_cnpq,
  },
  {
    year: "Mar 2024 - Jul 2025",
    title: "Diretoria de Presidência",
    company: "Empresa Júnior I9",
    description:
      "Liderança estratégica da empresa júnior. Gestão de projetos e apoio ao desenvolvimento organizacional com Notion. Contribuição na formação e capacitação de novos membros.",
    image: logo_inove,
  },
];
